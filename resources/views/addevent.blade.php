...
<input type="date" class="form-control" name="start_date" class="date" placeholder="Enter start date" /><br /><br />
<label for="">Enter end date of the event</label>
<input type="date" class="form-control" name="end_date" class="date" placeholder="Enter end date" /><br /><br />
